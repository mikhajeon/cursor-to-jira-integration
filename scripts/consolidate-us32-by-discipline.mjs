#!/usr/bin/env node
/**
 * US-3.2 (DPH-248): Put all subtask names with [UX], [DEV FE], [DEV BE]/[BE]/[3.2-BE] into
 * [3.2-UX] Tasks, [3.2-FE] Tasks, [3.2-BE] Tasks as numbered lists, then delete originals.
 *
 * Run from project root: node scripts/consolidate-us32-by-discipline.mjs
 * Dry run: node scripts/consolidate-us32-by-discipline.mjs --dry-run
 */
...
const PARENT = 'DPH-248'; // US-3.2 App-Creator Accesses and Manages Development Instance

const DISCIPLINES = [
  { key: 'UX', summary: '[3.2-UX] Tasks', pattern: /^\[UX\]/i },
  { key: 'FE', summary: '[3.2-FE] Tasks', pattern: /^\[DEV FE\]/i },
  { key: 'BE', summary: '[3.2-BE] Tasks', pattern: /^\[(DEV )?BE\]|^\[T?3\.2-BE\]/i },
];
